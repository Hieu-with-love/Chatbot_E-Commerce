...
INSERT INTO tbl_product (id, category_id, price, description, name, thumbnail_url) VALUES
                                                                                       (1, 1, 999.99, 'High-performance smartphone with 128GB storage', 'Smartphone X', 'https://example.com/smartphone_x.jpg'),
                                                                                       (2, 1, 1299.99, '15-inch laptop with 16GB RAM', 'Laptop Pro', 'https://example.com/laptop_pro.jpg'),
                                                                                       (3, 1, 199.99, 'Wireless earbuds with noise cancellation', 'Earbuds Z', 'https://example.com/earbuds_z.jpg'),
                                                                                       (4, 1, 499.99, 'Smartwatch with health tracking', 'Smartwatch S', 'https://example.com/smartwatch_s.jpg'),
                                                                                       (5, 1, 299.99, 'Portable Bluetooth speaker', 'Speaker V', 'https://example.com/speaker_v.jpg'),
                                                                                       (6, 2, 49.99, 'Casual cotton t-shirt', 'T-Shirt Basic', 'https://example.com/tshirt_basic.jpg'),
                                                                                       (7, 2, 89.99, 'Slim-fit jeans', 'Jeans Classic', 'https://example.com/jeans_classic.jpg'),
                                                                                       (8, 2, 149.99, 'Leather jacket', 'Jacket Cool', 'https://example.com/jacket_cool.jpg'),
                                                                                       (9, 2, 29.99, 'Running sneakers', 'Sneakers Run', 'https://example.com/sneakers_run.jpg'),
                                                                                       (10, 2, 19.99, 'Woolen scarf', 'Scarf Warm', 'https://example.com/scarf_warm.jpg');
